...
syn keyword scalaKeywordModifier abstract override final lazy implicit implicitly private protected sealed require super given using opaque open infix inline 
syn match scalaKeywordModifier "\<transparent\>" " conflicts with vim :syn-transparent when matched with 'keyword'

hi link scalaKeywordModifier Function

syn keyword scalaNull null
hi link scalaNull ERROR
